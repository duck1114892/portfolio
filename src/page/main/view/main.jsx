  ...
  return (
    <Layout>
      ...
      <Content style={{ padding: "0 48px" }}>
        <motion.div id="1" style={{ marginBottom: "300px" }}>
          ...
          >
            ...
            <Row
              gutter={12}
              style={{ flex: 1, justifyContent: "center", marginTop: "30px" }}
            >
              <Col
                span={3}
                xs={12}
